class Api {
    ...
    async getUserLists() {
        try {
            return await fetch(`${this.BASE_URL}/api/user/${localStorage.getItem("tracker_id_session")}/lists`, {
                method: 'GET',
                headers: this.createHeaders()
            });
        } catch (e) {
    ...
    async createCountryList(nombreLista, listarray) {
        try {
            return fetch(`${this.BASE_URL}/api/user/${localStorage.getItem("tracker_id_session")}/lists`, {
                method: "POST",
                headers: this.createHeaders(),
                body: JSON.stringify({
                    "name": nombreLista,
    ...
    async editCountryList(name, listId, countries) {
        try {
            return fetch(`${this.BASE_URL}/api/user/${localStorage.getItem("tracker_id_session")}/lists/${listId}`, {
                method: "PUT",
                headers: this.createHeaders(),
                body: JSON.stringify({
                    "name": name,
    ...
    async deleteUserList(listId) {
        try {
            return await fetch(`${this.BASE_URL}/api/user/${localStorage.getItem("tracker_id_session")}/lists/${listId}`, {
                method: "DELETE",
                headers: this.createHeaders()
            });
        } catch (e) {
